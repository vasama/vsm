...
template<bool HasMoreThanOne>
struct all_same;

template<>
struct all_same</* HasMoreThanOne: */ false>
{
	template<typename...>
...
template<>
struct all_same</* HasMoreThanOne: */ true>
{
