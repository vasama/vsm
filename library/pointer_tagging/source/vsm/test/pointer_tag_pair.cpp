...
static s array[2]; // NOLINT(readability-identifier-naming)

TEST_CASE("pointer_tag_pair", "[pointer_tagging][pointer_tag_pair]")
{
...
TEST_CASE("atomic<pointer_tag_pair>::fetch_add_pointer", "[pointer_tagging][pointer_tag_pair][atomic]")
{
...
TEST_CASE("atomic<pointer_tag_pair>::fetch_sub_pointer", "[pointer_tagging][pointer_tag_pair][atomic]")
{
...
TEST_CASE("atomic<pointer_tag_pair>::fetch_add_tag", "[pointer_tagging][pointer_tag_pair][atomic]")
{
...
TEST_CASE("atomic<pointer_tag_pair>::fetch_sub_tag", "[pointer_tagging][pointer_tag_pair][atomic]")
{
...
TEST_CASE("atomic<pointer_tag_pair>::fetch_and_tag", "[pointer_tagging][pointer_tag_pair][atomic]")
{
	atomic<pair_type> atom(pair_type(nullptr, 3));
...
TEST_CASE("atomic<pointer_tag_pair>::fetch_or_tag", "[pointer_tagging][pointer_tag_pair][atomic]")
{
...
TEST_CASE("atomic<pointer_tag_pair>::fetch_xor_tag", "[pointer_tagging][pointer_tag_pair][atomic]")
{
	atomic<pair_type> atom(pair_type(nullptr, 3));
