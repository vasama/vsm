...
#define vsm_type_id_instance(...) \
	template ::vsm::detail::type_id_object const ::vsm::detail::type_id_instance<__VA_ARGS__>; \
	static_assert(::std::is_same_v<::vsm::detail::type_id_object_type<__VA_ARGS__>, ::vsm::detail::type_id_object>)
