...
class vsm_algorithm_recipe(ConanFile):
	name = "vsm-algorithm"
	version = "0.1"
	...
	def package_info(self):
		self.cpp_info.set_property("cmake_file_name", "vsm-algorithm")
		self.cpp_info.set_property("cmake_target_name", "vsm::algorithm")
