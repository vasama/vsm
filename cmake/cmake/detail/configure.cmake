...
set(vsm_detail_configure_lib_opt_n
	HEADERS
	HEADER_LINK_LIBRARIES
	HEADER_DEFINITIONS
	TEST_SOURCES
	TEST_LINK_LIBRARIES
	INTERNAL_LINK_LIBRARIES
)
...
function(vsm_detail_configure name target public_type)
		...
		if(${configure_visualizers}) # Configure visualizer export
			...
			if(NOT VSM_OPT_INTERNAL)
				vsm_add_cmake_package_setup(
					...
					INCLUDE "${CMAKE_CURRENT_FUNCTION_LIST_DIR}/scripts/import_visualizers_v1.cmake"
	...
	if(vsm_detail_do_configure AND DEFINED VSM_OPT_HEADER_LINK_LIBRARIES)
		target_link_libraries(${target} ${public_type} ${VSM_OPT_HEADER_LINK_LIBRARIES})
	endif()

	if(vsm_detail_do_configure AND DEFINED VSM_OPT_SOURCE_LINK_LIBRARIES)
		target_link_libraries(${target} PRIVATE ${VSM_OPT_SOURCE_LINK_LIBRARIES})
	endif()
	...
	if(vsm_detail_do_configure AND DEFINED VSM_OPT_TEST_LINK_LIBRARIES)
		get_target_property(test_target ${target} vsm_detail_test_target)

		if(NOT ${test_target} STREQUAL "test_target-NOTFOUND")
			target_link_libraries(${test_target} PRIVATE ${VSM_OPT_TEST_LINK_LIBRARIES})
		else()
			message(SEND_ERROR "Cannot specify test dependencies for target ${target} without test sources.")
		endif()
	endif()

	if(vsm_detail_do_configure AND DEFINED VSM_OPT_INTERNAL_LINK_LIBRARIES)
		target_link_libraries(${target} PRIVATE ${VSM_OPT_INTERNAL_LINK_LIBRARIES})

		get_target_property(test_target ${target} vsm_detail_test_target)
		if(NOT ${test_target} STREQUAL "test_target-NOTFOUND")
			target_link_libraries(${test_target} PRIVATE ${VSM_OPT_INTERNAL_LINK_LIBRARIES})
		endif()
	endif()
