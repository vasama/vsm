function(vsm_detail_configure target public_type)
	...
	if(DEFINED OPT_HEADER_DEFINITIONS)
		target_compile_definitions(${target} ${public_type} ${OPT_HEADER_DEFINITIONS})
	endif()

	if(DEFINED OPT_SOURCE_DEFINITIONS)
		target_compile_definitions(${target} PRIVATE ${OPT_SOURCE_DEFINITIONS})
	endif()
